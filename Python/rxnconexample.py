...
excel_book = ExcelBook("/home/adrian/Internship/CCR2_rxncon/CCR2_master/CCR2_rxncon_master_2019_07_05.xlsx")
...
print([state for state in states if (state.name == "CCR2_[Gai]--0" or state.name == "Pyk2_[(P)]-{{p}}")])
